...
<%@include file="../views/ClientDashBoard.jsp"%>
	...
	<table class="table table-striped tableFixHead">
		...
		<tbody>
			<%
			List<Order> orders = (ArrayList<Order>)request.getAttribute("ordersByUser");
			if(orders!=null){
			...
			<tr>
				...
				<td>
					...
					<a href="/viewOrderMenu?userId=<%=order.getUserId()%>"><button class="btn btn-sm btn-success" >Cancel</button></a>
				</td>  
			</tr>
